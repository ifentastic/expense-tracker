    ...
    // https://github.com/chrisblakely01/react-budget-app/blob/main/src/context/AppContext.js
    ...
    // Set initial state when app loads (my own expense items)
    const initialState = {
        budget: 3000,
        expenses: [
    ...
    export function ExpenseProvider({ children }) {
        ...
        // Fetch expenses from backend when the component mounts (my work)
        useEffect(() => {
